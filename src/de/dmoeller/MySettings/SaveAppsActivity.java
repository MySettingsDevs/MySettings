...
// Über den ListViewModAdapter werden zur Laufzeit die Einträge der Liste modifiziert!
...
// dargestellt werden könnnen!
	...
	public void onClick(View v) {		
		if (v == SaveAppButton) {			
			// Wenn der Sichern Button betätigt wird, wird ein Bitte Warten Dialog registiert
			...
			AppsSichern = ProgressDialog.show(this, "Bitte warten...",
					"Ausgewählte Apps werden gesichert",
			...
			new Thread() {
				...
				public void run() {
					...
					AppsSichern.dismiss(); // dialog schließen
				}
...
// Alle bisher als gespeichert markierten Apps aus der Datenbank löschen
